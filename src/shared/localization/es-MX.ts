...
export const esMX: TranslationKey = {
                            ...
                            // Hardware Status - EXPANDED AND ENHANCED
                            hardware: {
                              ...
                              status_check: 'Verificación de Estado del Sistema',
                              connection_failed: 'Conexión {type} fallida - Intento {attempt}/{max}',
                              ...
                              printer_init_failed: 'Error al inicializar impresora térmica',
                              test_print: 'IMPRESIÓN DE PRUEBA',
                              test_successful: 'Prueba Exitosa',
                              // USB Printer specific messages
                              usb_device_not_found: 'Impresora USB no detectada - Verifique la conexión',
                              usb_permission_denied: 'Sin permisos para acceder a la impresora USB',
                              usb_device_busy: 'Impresora USB ocupada - Intente nuevamente',
                              usb_communication_error: 'Error de comunicación con impresora USB',
                              usb_device_disconnected: 'Impresora USB desconectada durante operación',
                ...
                hardware_status: 'Estado del Hardware',
                real_time_monitoring: 'Monitoreo en tiempo real'
                           ...
                           audit: {
                             ...
                             lost_ticket_processed: 'Boleto extraviado procesado exitosamente',
                             lost_ticket_no_original_processed: 'Boleto extraviado procesado (sin boleto original)',
